...
```
This is useful to check if your alignment is close in size to your reference or not. If not, there might be a sample or various samples that are more divergent to the rest, and you might have to remove it/them from the alignment.
